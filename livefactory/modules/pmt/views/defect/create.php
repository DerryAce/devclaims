...
$(document).ready(function(e) {
   ...
   $('#defect-project_id').change(function(){
	 ...
	 /*$.post('index.php?r=pmt/defect/ajax-user-projects&user_id='+$(this).val(),function(r){

		$('#defect-project_id').html(r) ;
 ...
 <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                        ...
                        <h5><?= Yii::t('app', "Create Defect") ?> <small class="m-l-sm"><?= Yii::t('app', "Enter Defect Name, Start Time, ETA & Description") ?></small></h5>
