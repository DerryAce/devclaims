...
$(document).ready(function(e) {
    ...
    $(document).on('click','.stopTime',function(){
		...
		$('#NotesSubmit').click(function(event){
			...
			sageLength = CKEDITOR.instances['defectnotes'].getData().replace(/<[^>]*>/gi, '').length;
...
<div class="modal fade defectnotes">
  ...
  <div class="modal-dialog  modal-lg">
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title"><?=Yii::t('app','Defect Timing Notes')?></h4>
        ...
        <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="controls">
                      ...
                      <textarea class="form-control input-sm ckeditor" name="defectnotes" id="defectnotes" rows="8" style="width:100%"></textarea>
