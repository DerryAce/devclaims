...
$(document).ready(function(e) {
   ...
   $('#task-actual_start_datetime').val('0000-00-00'); 

   $('#task-actual_end_datetime').val('0000-00-00'); 
 ...
 <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                        ...
                        <h5><?= Yii::t('app', "Incident Create") ?> <small class="m-l-sm"><?= Yii::t('app', "Enter Reference Number, DV Status, Payment Date & Description") ?></small></h5>
