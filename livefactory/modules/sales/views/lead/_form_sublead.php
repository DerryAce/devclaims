    ...
    <?php
			 ...
			 <div class="col-sm-3">
                ...
                <div class="form-group">
                    ...
                    <label class="control-label" for="lname"><?=Yii::t('app','Expected Completion Date')?>:</label>
			 ...
			 <div class="col-sm-3">
                ...
                <div class="form-group">
                    ...
                    <label class="control-label" for="lname"><?=Yii::t('app','Completion Time')?>:</label>
				...
				//$form->hiddenField($sub_lead,'parent_id',array('value'=>$_GET['id']));



			echo Html::submitButton ( $sub_lead->isNewRecord ? Yii::t('app','Create') : Yii::t('app','Update'), [ 
