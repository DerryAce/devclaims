...
$(document).ready(function(e) {
	...
	$(document).on('click','.addTiming',function(){
			...
			$('#start_time').change(function(){
				...
				$.post('<?=$_SESSION['base_url']?>?r=pmt/lead/ajax-lead&id=<?=$_REQUEST['id']; ?>&start_time='+escape($(this).val())+'&eid=<?=$_REQUEST['time_entry_id']; ?>',function(result){
			...
			$('#end_time').change(function(){
					...
					$.post('<?=$_SESSION['base_url']?>?r=pmt/lead/ajax-lead-time-date-validation&start_time='+escape(start_time)+'&end_time='+escape(end_time),function(result){
...
<div class="modal fade lead_timing">
  ...
  <div class="modal-dialog  modal-lg">
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title"><?=Yii::t('app','Lead Timing')?></h4>
