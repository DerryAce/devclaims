...
$this->title =Yii::t('app','Lead Spent Time Reports');
...
function getTimeDiff($start,$end){
	...
	$dates=array();
		...
		}else if($_REQUEST['date']=='last_week'){
    ...
    <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                ...
                echo '<label class="control-label">'.Yii::t('app','Start Date').'</label>';echo DatePicker::widget([    'name' => 'start_date','id'=>'start_date',    'type' => DatePicker::TYPE_COMPONENT_PREPEND,    'value' => $_REQUEST[start_date],    'pluginOptions' => [        'autoclose'=>true,        'format' => 'yyyy/mm/dd'    ]]);
        ...
        echo '<label class="control-label">'.Yii::t('app','End Date').'</label>';echo DatePicker::widget([    'name' => 'end_date', 'id'=>'end_date',   'type' => DatePicker::TYPE_COMPONENT_PREPEND,    'value' => $_REQUEST[end_date],    'pluginOptions' => [        'autoclose'=>true,        'format' => 'yyyy/mm/dd'    ]]);
        ...
        ?>
            ...
            <div class="col-sm-2">
                    ...
                    <label class="control-label" style="color:#fff;"><?php echo Yii::t('app','Search')?></label>

                <div class="form-group">

                      <input type="submit" value="<?php echo Yii::t('app','Search')?>" class="btn btn-success search">
...
<div class="panel panel-info">
	...
	<div class="panel-heading">
    	...
    	<h3 class="panel-title">
			<?php echo Yii::t('app','Lead Time Spent Report')?>
        	

            <div class="pull-right">

            	<a href="index.php?r=sales/lead/time-spent-report&date=last_month" class="btn btn-default btn-xs">

                
<?php echo Yii::t('app','Last Month')?>
                	

                </a>

                <a href="index.php?r=sales/lead/time-spent-report&date=this_month" class="btn btn-default btn-xs">
<?php echo Yii::t('app','This Month')?>
                	

                </a>

                <a href="index.php?r=sales/lead/time-spent-report&date=last_week" class="btn btn-default btn-xs">

    <?php echo Yii::t('app','Last Week')?>            	

                </a>

                <a href="index.php?r=sales/lead/time-spent-report&date=this_week" class="btn btn-default btn-xs">
<?php echo Yii::t('app','This Week')?>
    ...
    <div class="panel-body">
    	...
    	<?php if(count($dataProvider) > 0){ ?>
         ...
         <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <th><?php echo Yii::t('app','Customer')?></th>

                <th><?php echo Yii::t('app','Lead')?></th>

                <th><?php echo Yii::t('app','Type')?></th>

                <th><?php echo Yii::t('app','Time Spent')?> </th>

                <th><?php echo Yii::t('app','Approved')?></th>
        ...
        <?php foreach($dataProvider as $row){ ?>
            ...
            <tr>
                ...
                <td><a href="index.php?r=customer/customer/customer-view&id=<?=$row['cid']?>"><?=$row['customer_name']?></a></td>

                <td><a href="index.php?r=sales/lead/lead-view&id=<?=$row['tid']?>"><?=$row['lead_id']?>-<?=$row['lead_title']?></a></td>
        ...
        <tr>
            ...
            <td colspan="6" align="right">
                ...
                <strong><?php echo Yii::t('app','Total Spent Time')?> : <?=$spend_t?></strong>
...
<script type="text/javascript">
            ...
            var chart = new google.visualization.ColumnChart(document.getElementById('leadTiming'));
