...
$this->title=Yii::t ( 'app', 'Lead Closed Report');
...
$(document).ready(function(e) {
   ...
   $('.search').click(function(event){
				...
				if(startTime>endTime){
					 ...
					 error+=Add_Error($('#end_date'),'<?=Yii::t ( 'app', 'Start Time Should be Less then End Time')?>');
...
<form action="index.php?r=sales/lead/lead-closed-reports" method="post">
	...
	<div class="panel-heading">
    	...
    	<h3 class="panel-title"><?=$this->title?>
        	...
        	<div class="pull-right">
            	...
            	<a href="index.php?r=sales/lead/lead-closed-reports&date=last_month" class="btn btn-default btn-xs">
...
<?=Yii::t ( 'app', 'Last Month')?>
                ...
                <a href="index.php?r=sales/lead/lead-closed-reports&date=this_month" class="btn btn-default btn-xs">
<?=Yii::t ( 'app', 'This Month')?>
                	

                </a>

                <a href="index.php?r=sales/lead/lead-closed-reports&date=this_week" class="btn btn-default btn-xs">
<?=Yii::t ( 'app', 'This Week')?>
                	

                </a>

                <a href="index.php?r=sales/lead/lead-closed-reports&date=yesterday" class="btn btn-default btn-xs">
<?=Yii::t ( 'app', 'Yesterday')?>
                	

                </a>

                <a href="index.php?r=sales/lead/lead-closed-reports&date=today" class="btn btn-default btn-xs">
<?=Yii::t ( 'app', 'Today')?>
	...
	if(!in_array($_GET['date'],$filter)){
            ...
            <div class="col-sm-6">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title"><?=Yii::t ( 'app', 'Lead Closed Report Table')?></h3>
            ...
            <div class="col-sm-6">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title"><?=Yii::t ( 'app', 'Lead Closed Report Chart')?></h3>

                    </div>

                    <div class="panel-body">

                        <div id="leadClosed" style="height:350px"></div>
        ...
        <script type="text/javascript">
            ...
            var chart = new google.visualization.ColumnChart(document.getElementById('leadClosed'));
        ...
        <?php 
				...
				foreach($dataProvider as $row){
					...
					if(!in_array($row['first_name'],$users)){
						...
						$userCount[$time][$row['first_name']]= $row['leadcount'];
