...
if(Yii::$app->user->identity->id == $assigned_user_id){

	if(isset($_COOKIE['lead_start_time'])){
	...
	$timeBtn='<a href="javascript:void(0)" class="btn btn-sm   btn-danger stopTime"  data-toggle="modal" ><i class="glyphicon glyphicon-time"></i> End Timer</a>'; 
		...
		$timeBtn='<a href="index.php?r=sales/lead/lead-view&id='.$_GET['id'].'&starttime=true" class="btn btn-sm  btn-success "><i class="glyphicon glyphicon-time"></i> Start Timer</a>';}
...
Yii::$app->request->enableCsrfValidation = true;
	...
	Pjax::begin(); echo GridView::widget([
        ...
        //'filterModel' => $searchModelLeadTime,
  ...
  //          'id',
        ...
        'panel' => [
            ...
            'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-th-list"></i> '.Yii::t ( 'app', 'Lead Timing').' </h3>',

            'type'=>'info',

            'before'=>'<a href="javascript:void(0)" class="btn btn-success btn-sm addTiming" onClick="$(\'.lead_timing\').modal(\'show\');"><i class="glyphicon glyphicon-plus"></i> '.Yii::t ( 'app', 'Add Manual Entry').'</a> '.$timeBtn,             'after'=>'<div class="total_timing" align="right">ddd</div>',
