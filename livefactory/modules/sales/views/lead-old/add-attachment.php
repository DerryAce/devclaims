...
function validation(){
	if($('#att').val()	==''){
		...
		$('.help-block').text('This Field Required!');
...
<div class="ibox float-e-margins">
        <div class="ibox-title">
         ...
         <div class="ibox-content">
             <div class="row">
             	<div class="col-sm-6">
             	 Note Attachment Type: <i>doc/xls/pdf/images/audio/vedio/zip</i>                
                </div>
                <div class="col-sm-6" align="right">
                	<input type="button" class="btn btn-success btn-sm" onClick="addAttach()" value="Add More Files">
    ...
    <input type="hidden" name="_csrf" value="<?php echo $this->renderDynamic('return Yii::$app->request->csrfToken;'); ?>">
           ...
           <div class="row">
				...
				<a href="index.php?r=sales/lead/lead-view&id=<?=$entity_id?>" class="btn btn-warning"> Skip</a>
                </div>
           </div>
         </form>
       </div>
