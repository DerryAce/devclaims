...
Yii::$app->request->enableCsrfValidation = true;
  ...
  //          'id',
        ...
        'panel' => [
            'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-th-list"></i> Lead Timing </h3>',
            'type'=>'info',
            'before'=>'<a href="javascript:void(0)" class="btn btn-success btn-sm addTiming" onClick="$(\'.lead_timing\').modal(\'show\');"><i class="glyphicon glyphicon-plus"></i>Add Manual Entry</a> '.$timeBtn,             'after'=>'<div class="total_timing" align="right">ddd</div>',
            'showFooter'=>false
        ],
    ]); Pjax::end(); 
