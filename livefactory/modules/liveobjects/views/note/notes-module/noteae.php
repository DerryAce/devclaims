						...
						<div class="form-group">
						 ...
						 <div class="form-group">
							...
							<div class="col-sm-offset-2 col-sm-10">
								...
								<button class="btn btn-primary notesAdd" type="submit" name="Submit" value="Save Notes"/><i class="fa fa-comment"></i> <?=Yii::t('app', 'Save')?></button>
						...
						<div class="form-group">
						 ...
						 <div class="form-group">
							...
							<div class="col-sm-offset-2 col-sm-10">
								...
								<button class="btn btn-primary note-edit" type="submit" name="noteedit" value="Save Notes"/><i class="fa fa-comment"></i> <?=Yii::t('app', 'Update')?></button>
