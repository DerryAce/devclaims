   ...
   <!-- <div class="page-header">
    ...
    //        'id',
           ...
           // 'status',
			...
			['attribute'=>'status','value'=> $model->status?Yii::t('app', 'Active'):Yii::t('app', 'Inactive'), 'type'=>DetailView::INPUT_DROPDOWN_LIST,'items'=>array(''=>'--Select--','0'=>Yii::t('app', 'Inactive'),'1'=>Yii::t('app', 'Active'))]
